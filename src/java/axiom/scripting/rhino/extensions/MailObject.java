 ...
 *
 * $RCSfile: MailObject.java,v $
 * $Author: stefanp $
 * $Revision: 1.8 $
 * $Date: 2003/12/23 12:39:10 $
 */
...
public class MailObject extends ScriptableObject implements Serializable {
    ...
    public static void init(Scriptable scope, Properties props) {
        ...
        String[] mailFuncs = {
                ...
                "setReplyTo", "getStatus", "setStatus" };
        try {
     ...
     * @param contentType optional content type, default is text/plain 
     */
    public void addPart(Object obj, Object filename, Object contentType) { 
        try {
            ...
            if (contentType == null || contentType == Undefined.instance) {
            ...
            if (obj instanceof String) {
                part.setContent(obj.toString(), contentType.toString()); 
