...
public abstract class AbstractRepository implements Repository {
    ...
    /**
     * Return if the repository has the indicated resource
     * @param name
     * @return true if resource name exists in this repository
     */
    public synchronized boolean hasResource(String name){
    	update();
    	return resources.get(name) == null ? false : true;    
    }
