 ...
 *
 * $RCSfile: TransientNode.java,v $
 * $Author: hannes $
 * $Revision: 1.10 $
 * $Date: 2003/07/08 13:52:35 $
 */
 ...
 * object, class axiom.objectmodel.db.Node has to be used.
 */
public class TransientNode implements INode, Serializable {
    ...
    private Property makeVirtualNode(String propname, Relation rel) {
        INode node = new axiom.objectmodel.db.Node(rel.getPropName(), rel.getPrototype(),
