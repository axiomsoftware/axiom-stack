 ...
 *
 * $RCSfile: IDatabase.java,v $
 * $Author: hannes $
 * $Revision: 1.6 $
 * $Date: 2005/03/23 14:57:28 $
 */
...
public interface IDatabase {
    ...
    public INode getNode(ITransaction transaction, String key, int mode, boolean multiLayers)
    				throws IOException, ObjectNotFoundException;
    ...
    public INode getNode(String key, final int mode)
        throws IOException, ObjectNotFoundException;
