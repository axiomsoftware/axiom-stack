 ...
 *
 * $RCSfile: UpdateableSubnodeList.java,v $
 * $Author: hannes $
 * $Revision: 1.3 $
...
public class UpdateableSubnodeList extends OrderedSubnodeList {
     ...
     * @throws ClassNotFoundException @see axiom.objectmodel.db.DbMapping#getColumn(String)
     * @throws SQLException @see axiom.objectmodel.db.DbMapping#getColumn @see axiom.objectmodel.db.DbMapping#needsQuotes(String)
     */
    ...
    private Node updateBorder(int idx, NodeHandle nh, Node node) {
        ...
        if (rel.otherType.getIDField().equals(cret)) {
            ...
            if (node == null) {
                System.out.println("**updateBorder**");
    ...
    private void rebuildBorders(NodeHandle nh) {
        ...
        System.out.println("**rebuildBorders**");
